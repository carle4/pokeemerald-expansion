...
#define FLAPPY_VAR_HIGH_SCORE           VAR_ROUTE120_STATE  // If this variable isn't set to 0, this tracks the high score of the Flappy Bird minigame
...
#define FLIP_VAR_LEVEL                  VAR_ROUTE117_STATE   // If this variable isn't set to 0, it will track the difficult level for any game of Voltorb Flip after the first one
