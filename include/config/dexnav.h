...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x2BB // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x2BA // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x2B9 // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x40FF // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x40FE // Steps for finding hidden pokemon
